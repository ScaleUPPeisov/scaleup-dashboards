...
pub fn run(){
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![studio_drafts::studio_drafts_start_bridge,studio_drafts::studio_drafts_list,studio_drafts::studio_drafts_clear,updater_bridge::prepare_updater_tempdir,
            ...
            system::diagnostics,system::default_workspace,system::endlume_diagnostics,system::updater_manifest_diagnostics,
            youtube::youtube_channel_stats,youtube::youtube_oauth_recovery_diagnostic,youtube::youtube_keychain_migration_diagnostics,youtube::youtube_oauth_browsers,youtube_intelligence::youtube_channel_analytics,youtube_intelligence::youtube_competitor_snapshot,youtube_intelligence::youtube_discover_competitors,youtube::youtube_oauth_profiles,youtube::youtube_google_project_diagnostic,youtube::youtube_google_config_status,youtube::youtube_google_config_import,youtube::youtube_oauth_connect_global,youtube::youtube_oauth_reconnect_existing,youtube::youtube_oauth_profile_health,youtube::youtube_cache_thumbnail,youtube::youtube_oauth_connect,youtube::youtube_oauth_disconnect,youtube::youtube_upload_video,youtube::youtube_resume_upload,youtube::youtube_upload_sessions,youtube::youtube_active_uploads,youtube::youtube_cancel_upload_session,youtube::youtube_set_thumbnail,youtube::youtube_file_fingerprint,youtube::youtube_list_existing_videos,youtube::youtube_backup_existing_videos,youtube::youtube_update_existing_video,youtube::youtube_update_existing_schedule,youtube::youtube_list_playlists,youtube::youtube_playlist_membership,
