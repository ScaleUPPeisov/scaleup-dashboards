...
export function AuthRecoveryCenter(){
 ...
 return <section className="settingsCard authRecoveryCenter">
  ...
  {preReconnectProfileId&&(()=>{const r=rows.find(x=>x.profileId===preReconnectProfileId);return <div className="modalBackdrop" onMouseDown={()=>setPreReconnectProfileId('')}>
  ...
  {wrongChannel&&<div className="modalBackdrop" onMouseDown={()=>setWrongChannel(null)}><section className="confirmModal browserPicker" onMouseDown={e=>e.stopPropagation()}>
