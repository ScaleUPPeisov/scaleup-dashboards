...
export function RecoveryGate(){
  ...
  return <div className="recoveryOverlay"><section className="recoveryDialog">
    <small>ВОССТАНОВЛЕНИЕ VYRON YT PEISOV</small><h2>Производство было прервано</h2><h3>{recovery.channelName}</h3>
