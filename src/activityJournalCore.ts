...
const TYPES=new Set<ActivityEventType>([
 ...
 'INVENTORY_SYNC_STARTED','INVENTORY_SYNC_COMPLETED','INVENTORY_SYNC_PARTIAL','SOURCE_TRASH_REQUESTED','SOURCE_TRASHED','SOURCE_MISSING','SOURCE_RECOVERED','OAUTH_RECONNECT','CHANNEL_REBOUND','STATS_REFRESH_BATCH','CHANNEL_STATS_REFRESH'
]);
