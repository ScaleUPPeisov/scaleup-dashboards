...
const TYPES=new Set<ActivityEventType>([
 'RENDER_COMPLETED','RENDER_DISCOVERED_LEGACY','RENDER_FOLDER_SCANNED','LOCAL_VIDEO_DISCOVERED',
 'UPLOAD_QUEUED','UPLOAD_STARTED','UPLOAD_PROGRESS','UPLOAD_ACCEPTED','UPLOAD_BLOCKED_DUPLICATE_GUARD','REMOTE_VIDEO_VERIFIED','REMOTE_VIDEO_MISSING','REMOTE_LINK_CLEARED','RECONCILIATION_COMPLETED','YOUTUBE_PROCESSING','YOUTUBE_READY','UPLOAD_FAILED',
