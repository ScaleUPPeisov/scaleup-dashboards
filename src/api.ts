...
export type OAuthExistingProfileRecoveryRow={profileUuid:string;expectedChannelId?:string|null;refreshAccount:string;status:OAuthExistingProfileRecoveryStatus;reasonCode:string;tokenRefresh:'PASS'|'NOT_RUN';clientSecretSource?:'PROFILE_CANONICAL'|'GLOBAL_EXACT_MATCH'|'GLOBAL_CURRENT_MIGRATION'|null;browserLaunches:0;youtubeApiRequests:0;credentialsDialogs:0;keychainPasswordDialogs:0;secretValuesIncluded:false};
...
export type OAuthReconnectWrongChannel={ok:false;status:'WRONG_CHANNEL';code:'WRONG_CHANNEL';profileId:string;profileUuidPreserved:true;expectedChannelId:string;expectedChannelTitle?:string|null;authorizedChannels:OAuthAuthorizedChannel[];browser:string;credentialsCommitted:false;refreshPointerChanged:false;clientSecretPointerChanged:false;generationChanged:false;videosInsert:0;secretValuesIncluded:false};
