...
export type OAuthCredentialStateProfile={profileUuid:string;channelTitle?:string|null;expectedChannelId?:string|null;canonicalAccount:string;canonicalRefreshPresent:boolean;canonicalRefreshMetadata?:CanonicalAccountDiagnostic;keychainDenial?:KeychainDenialDiagnostic|null;legacyRefreshPresent:boolean;migrationState:string;credentialState:OAuthCredentialState;credentialSchemaVersion:2;lastValidatedAt?:string|null;lastValidationResult:string;clientSecretState:'PROFILE_CANONICAL'|'GLOBAL_EXACT_MATCH'|'GLOBAL_CURRENT_READY'|'CLIENT_SECRET_REIMPORT_REQUIRED'|'MISSING';clientSecretPresent:boolean;secretValuesIncluded:false;youtubeApiRequests:0;keychainSecretReads:0};
