...
export type YoutubeProcessingStatus={videoId:string;channelId?:string;identityVerified:boolean;processingStatus:string;processingState:'READY'|'YOUTUBE_PROCESSING'|'PROCESSING_FAILED'|'PROCESSING_UNKNOWN';processingCheckedAt:string;processingProgress?:{partsTotal?:string|null;partsProcessed?:string|null;timeLeftMs?:string|null};processingFailureReason?:string|null;processingIssuesAvailability?:string|null;rejectionReason?:string|null;uploadStatus?:string|null;privacyStatus?:string|null;publishAt?:string|null};
