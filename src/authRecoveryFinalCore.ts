export type FinalAuthStatus='CONNECTED'|'CANONICAL_PRESENT_UNVERIFIED'|'RECONNECT REQUIRED'|'MISSING'|'CONNECTING'|'VALIDATING'|'WRONG CHANNEL'|'FAILED';
