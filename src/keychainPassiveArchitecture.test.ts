...
const rust=fs.readFileSync(testFilePath('../src-tauri/src/youtube.rs',import.meta.url),'utf8');
const storage=fs.readFileSync(testFilePath('../src-tauri/src/storage.rs',import.meta.url),'utf8');
const security=fs.readFileSync(testFilePath('../src-tauri/src/security.rs',import.meta.url),'utf8');
