...
const api=readFileSync(testFilePath('./api.ts',import.meta.url),'utf8');
const rust=readFileSync(testFilePath('../src-tauri/src/youtube.rs',import.meta.url),'utf8');
const lib=readFileSync(testFilePath('../src-tauri/src/lib.rs',import.meta.url),'utf8');
