...
describe('VYRON 2.1.3 updater hotfix',()=>{
  it('uses the dedicated Windows feed first and shared manifest as fallback',()=>{
    expect(UPDATER_ENDPOINTS[0]).toBe('https://raw.githubusercontent.com/ScaleUPPeisov/scaleup-dashboards/main/vyron-updates/windows-latest.json');
    expect(UPDATER_ENDPOINTS[1]).toBe('https://raw.githubusercontent.com/ScaleUPPeisov/scaleup-dashboards/main/vyron-updates/latest.json');
  });
