...
export type DistributionMode='even'|'random'|'no-repeat';
...
export const productionManagerApi={
  ...
  openInEndlume:(endlumePath:string,manifestPath:string)=>invoke<void>('open_production_batch_in_endlume',{endlumePath,manifestPath}),
