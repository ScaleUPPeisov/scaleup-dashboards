...
export function youtubeQuotaMessage(){const r=youtubeQuotaResetLocalInfo();return `Квота YouTube Data API исчерпана. VYRON поставил YouTube-запросы на паузу до ${r.time} (${r.date}) по вашему местному времени. Базовый сброс Google: 00:00 Pacific Time. Черновики и незавершённые пачки сохранены.`}
