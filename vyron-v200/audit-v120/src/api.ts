...
const METHOD_LEDGER_COMMANDS=new Set(['youtube_oauth_profile_health','youtube_upload_video','youtube_list_existing_videos','youtube_backup_existing_videos','youtube_update_existing_video','youtube_set_thumbnail']);
...
export const api={
  ...
  youtubeFileFingerprint:(filePath:string)=>invoke<YoutubeFileFingerprint>('youtube_file_fingerprint',{filePath}),
